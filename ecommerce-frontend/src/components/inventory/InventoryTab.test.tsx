...
describe('InventoryTab', () => {
  ...
  it('shows loading spinner before data arrives', () => {
    mockedInventoryApi.getAll.mockReturnValue(new Promise(() => {})); // never resolves
    render(<InventoryTab />);
  ...
  it('filters to only low-stock items when Low Stock button clicked', async () => {
    render(<InventoryTab />);
  ...
  it('returns to all items when All items button is clicked', async () => {
    render(<InventoryTab />);
    await waitFor(() => screen.getAllByTestId('inventory-row'));
  ...
  it('hides banner when low-stock filter is active', async () => {
    render(<InventoryTab />);
    await waitFor(() => screen.getAllByTestId('inventory-row'));
  ...
  it('shows error state on fetch failure', async () => {
    mockedInventoryApi.getAll.mockRejectedValue(new Error('Network error'));
    render(<InventoryTab />);
  ...
  it('refetches data when retry button is clicked', async () => {
    mockedInventoryApi.getAll.mockRejectedValueOnce(new Error('fail'));
    mockedInventoryApi.getAll.mockResolvedValueOnce(ITEMS);
